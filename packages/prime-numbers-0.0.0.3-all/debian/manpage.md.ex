% prime-numbers(SECTION) | User Commands
%
% "March  8 2024"
...
prime-numbers - program to do something

# SYNOPSIS

**prime-numbers** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**prime-numbers** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **prime-numbers** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**prime-numbers** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    prime-numbers. See **foo.conf**(5) for further details.
...
**prime-numbers** provides some return codes, that can be used in scripts:
